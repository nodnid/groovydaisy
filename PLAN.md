...
**Goal:** Mirror tracks to MIDI out for external gear

**Modify:** `pod/GroovyDaisy/GroovyDaisy.cpp`

**Implementation:**
1. Initialize MIDI output
2. On drum trigger → send Note On
3. On synth note → send Note On/Off
4. Send MIDI clock (24 PPQN)

**Test:**
- Connect external synth to MIDI out
- Play pattern, hear external synth
...
**Modify:** `pod/GroovyDaisy/protocol.h`

**Companion:**
- Drag-drop WAV file
- Convert to float samples
- Chunk and send via serial
- Progress indicator
